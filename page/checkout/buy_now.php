...
// ตรวจว่า product มีจริง (กัน id เพี้ยน)
$pdo = new PDO("mysql:host=localhost;dbname=shopdb;charset=utf8mb4", "root", "", [
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
    PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC,
]);
$stm = $pdo->prepare("SELECT id,name,price FROM products WHERE id=? LIMIT 1");
...
// เขียน session สำหรับ buy now (ทับของเดิม — ต้องการซื้อทีละชิ้น)
$_SESSION['buy_now'] = [
